...
public static class Int64IdExtensions
{
    /// <summary>
    /// Returns the friendly name for a property, such as an Enum name or DateTime.  If missing returns null
    /// </summary>
    public static string Friendly(this WorldObject wo, Int64Id key) => wo.TryGet(key, out var value) ? key.Friendly(value) : null;
    public static bool TryGetFriendly(this WorldObject wo, Int64Id key, out string friendly) => wo.TryGet(key, out var value) ?
    ...
    /// Returns the friendly name for a property, such as an Enum name or DateTime.  If missing returns null
    /// </summary>
    public static string Friendly(this Int64Id key, long value) => key switch
    {
    ...
    public static bool TryGetFriendly(this Int64Id key, long value, out string friendly) => (friendly = key.Friendly(value)) is not null;

    /// <summary>
    /// Tries to find the Enum associated with a property key
    /// </summary>
    public static bool TryGetEnum(this Int64Id key, out Type enumType) => _enums.TryGetValue(key, out enumType);

    /// <summary>
    /// Returns a descriptive label for a property, defaulting to the name of the property
    /// </summary>
    public static string Label(this Int64Id key) => _labels.TryGetValue(key, out var label) ? label : key.ToString();
    ...
    /// </summary>
    public static string Format(this WorldObject wo, Int64Id prop)
    {
    ...
    static readonly Dictionary<Int64Id, string> _formatStrings = new()
    {

    };

    static readonly Dictionary<Int64Id, string> _labels = new()
    {

    };

    static readonly Dictionary<Int64Id, Type> _enums = new()
    {
