...
public static class InstanceIdExtensions
{
    ...
    /// </summary>
    public static string Friendly(this WorldObject wo, InstanceId key) => wo.TryGet(key, out var value) ? key.Friendly(value) : null;
    public static bool TryGetFriendly(this WorldObject wo, InstanceId key, out string friendly) => wo.TryGet(key, out var value) ?
    ...
    /// Returns the friendly name for a property, such as an Enum name or DateTime.  If missing returns null
    /// </summary>
    public static string Friendly(this InstanceId key, uint value) => key switch
    {
    ...
    public static bool TryGetFriendly(this InstanceId key, uint value, out string friendly) => (friendly = key.Friendly(value)) is not null;

    /// <summary>
    /// Tries to find the Enum associated with a property key
    /// </summary>
    public static bool TryGetEnum(this InstanceId key, out Type enumType) => _enums.TryGetValue(key, out enumType);

    /// <summary>
    /// Returns a descriptive label for a property, defaulting to the name of the property
    /// </summary>
    public static string Label(this InstanceId key) => _labels.TryGetValue(key, out var label) ? label : key.ToString();
    ...
    /// </summary>
    public static string Format(this WorldObject wo, InstanceId prop)
    {
    ...
    /// </summary>
    public static string Format(this InstanceId prop, params object[] values)
    {
    ...
    static readonly Dictionary<InstanceId, string> _formatStrings = new()
    {

    };

    static readonly Dictionary<InstanceId, string> _labels = new()
    {

    };

    static readonly Dictionary<InstanceId, Type> _enums = new()
    {
